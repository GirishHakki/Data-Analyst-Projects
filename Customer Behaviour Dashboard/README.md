...
1. **Clone the repository**
   ```bash
   git clone https://github.com/GirishHakki/Data-Analyst-Projects/Customer Behaviour Dashboard/
   ```
...
📺 Instagram: [Girish Hakki](https://www.instagram.com/girish_hakki/)
- Quick SQL tips, data memes, and behind-the-scenes content

💼 LinkedIn: [Girish Hakki](https://www.linkedin.com/in/girish-hakki/)
